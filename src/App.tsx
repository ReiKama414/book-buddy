      ...
      <div className="min-h-screen bg-gray-50 flex flex-col lg:pt-24 pt-36">
        ...
        <footer className="bg-white border-t border-gray-200 py-4">
          <div className="container mx-auto px-4 text-center text-gray-500 text-sm">
            ...
            <p className="mt-1">&copy; {new Date().getFullYear()} BookBuddy</p>
            <p className="mt-1">GitHub Repository: <a href="https://github.com/yourusername/bookbuddy" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">https://github.com/yourusername/bookbuddy</a></p>
          </div>
        </footer>
      </div>
    </Router>
